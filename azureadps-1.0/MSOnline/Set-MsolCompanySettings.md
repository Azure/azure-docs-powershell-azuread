...
Indicates whether to allow the use of the self-service password reset feature for administrators. This setting doesn't control the behavior for non-administrator accounts.

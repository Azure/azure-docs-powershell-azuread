...
```
Get-AzureADApplicationProxyConnectorGroup [-All <Boolean>] [-Filter <String>] [-Top <Int32>]
 [<CommonParameters>]
```

### UNNAMED_PARAMETER_SET_2
```
Get-AzureADApplicationProxyConnectorGroup [-All <Boolean>] -Id <String> [<CommonParameters>]
```

### UNNAMED_PARAMETER_SET_3
```
Get-AzureADApplicationProxyConnectorGroup [-All <Boolean>] [-SearchString <String>] [<CommonParameters>]
```

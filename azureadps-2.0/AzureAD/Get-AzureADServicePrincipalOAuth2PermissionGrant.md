...
See the [migration guide for Get-AzureADServicePrincipalOAuth2PermissionGrant](./migrate/Get-AzureADServicePrincipalOAuth2PermissionGrant.md) to the Microsoft Graph PowerShell.

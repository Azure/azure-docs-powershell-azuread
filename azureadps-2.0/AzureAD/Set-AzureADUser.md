...
```
PS C:\> $user = Get-AzureADUser | Where-Object {$_.UserPrincipalName -like "TestUser@example.com"}
PS C:\> $user.DisplayName = 'YetAnotherTestUser' 
PS C:\> Set-AzureADUser -ObjectId $user.ObjectId -Displayname $user.Displayname
```

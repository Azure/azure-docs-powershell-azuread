...
When assigning a role using Azure portal, role activation step is implicitly done by portal on admin's behalf. To get the full list of roles available in Azure AD, use [Get-AzureADDirectoryRoleTemplate](https://docs.microsoft.com/en-us/powershell/module/azuread/get-azureaddirectoryroletemplate?view=azureadps-2.0).

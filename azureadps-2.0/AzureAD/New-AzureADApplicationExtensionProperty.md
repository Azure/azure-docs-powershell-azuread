...
See the [migration guide for New-AzureADApplicationExtensionProperty](./migrate/New-AzureADApplicationExtensionProperty.md) to the Microsoft Graph PowerShell.

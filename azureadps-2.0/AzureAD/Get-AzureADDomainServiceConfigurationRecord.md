...
See the [migration guide for Get-AzureADDomainServiceConfigurationRecord](./migrate/Get-AzureADDomainServiceConfigurationRecord.md) to the Microsoft Graph PowerShell.
